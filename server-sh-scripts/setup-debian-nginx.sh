...
# then: ./setup-debian-nginx.sh 127.0.0.1 dotg.tech
# certbot --nginx
...
http {
  ...
  server {
    server_name $SITENAME.$DOMAIN_ZONE;
...
location ~ ^(/api/|/api-json|/docs|/helper.html) {
...
dotg:$apr1$ds9ZOm2b$YGcZQw61PuuccJS7gL6hS.
EOF
